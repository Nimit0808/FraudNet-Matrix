...
const CustomNode = ({ data, selected }) => {
    ...
    return (
        <div className={`p-3 rounded-full border bg-white flex flex-col items-center justify-center transition-all duration-300 w-[120px] h-[120px] ${selected ? 'border-[#005b9f] shadow-[0_0_0_3px_rgba(0,91,159,0.3)]' :
            ...
            <div className="text-[9px] text-gray-500 font-normal tracking-tight text-center truncate w-full px-1 mt-0.5">
                {data.label}
            </div>
        </div>
    );
...
export default function App() {
    ...
    const populateFlow = (data) => {
        ...
        const formattedEdges = data.edges.map(e => {
            const isSuspicious = e.data.pattern_label !== 'NORMAL';
            return {
                ...e,
                type: 'bezier',
                style: {
    ...
    const renderAICopilot = () => {
        ...
        return (
            <div className="flex flex-col h-full bg-[#f8f9fa] border-l-[4px] border-[#005b9f] p-4">
                <div className="flex items-center justify-between mb-4 border-b pb-2 border-gray-200">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[14px] font-bold text-[#005b9f]">Automated SAR Assessment</span>
                    </div>
                </div>
                <div className="flex-1">
                    ...
                    {isHighRisk && (
                        <div className="text-[12px] bg-[#ffeeee] border border-[#ffcccc] rounded p-2 text-[#cc0000] font-bold flex gap-2 items-center">
                            ...
                            <span>ACTION REQUIRED: Recommend filling FIU-IND Report immediately.</span>
                        </div>
                    )}
                </div>
    ...
    const renderActiveAlertQueue = () => (
        <div className="flex flex-col md:flex-row gap-4 h-[calc(100vh-180px)]">
            ...
            {/* RIGHT COLUMN: Graph (60%) + Copilot (40%) */}
            <div className="flex-1 flex flex-col gap-4 h-full min-w-0">
                ...
                <div className="flex-[2] union-panel overflow-hidden">
                    {renderAICopilot()}
                </div>
            </div>
        </div>
            ...
            <div className="union-panel max-w-2xl">
                ...
                <div className="p-6 space-y-5">
                    <div>
                        ...
                        <input type="number" defaultValue={10000} className="w-full border border-gray-300 rounded p-2 text-[13px] focus:outline-none focus:border-[#005b9f] bg-[#fbfbfb]" />
                    </div>
                    <div>
